...
class UsersSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'email', 'is_profile_complete', 'is_superuser', 'is_staff', 'date_joined', 'is_active', 'preferences', ]

    def to_representation(self, instance):
        rep = super().to_representation(instance)
        # rep['country'] = CountrySerializer(instance.countrys.all(), many=True).data
        return rep
